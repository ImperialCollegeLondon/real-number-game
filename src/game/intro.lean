...
This game is a sequel to <a href="http://wwwf.imperial.ac.uk/~buzzard/xena/natural_number_game/" target="blank">the natural number game</a>. You will need to have played the natural number game up to at least "Advanced Proposition world" to have any chance of getting anywhere with the real number game
a part-book part-game which shows the power of induction.
